...
import com.tw.userapp.repository.AuthorityRepository;
...
import com.tw.userapp.service.mapper.UserMapper;
...
public class UserService {
    ...
    public UserService(UserMapper userMapper, UserRepository userRepository, AuthorityRepository authorityRepository, CacheManager cacheManager) {
   ...
   public User registerUser(UserDTO userDTO) {
      ...
      //  Authority authority = authorityRepository.findOne(userDTO.);
       ...
       if(userDTO.getAuthorities() != null) {
           for ( String auth: userDTO.getAuthorities()) {
               authorities.add(authorityRepository.getOne(auth));
           }
       }
